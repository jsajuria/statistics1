...
\begin{verbatim}
 [1] 3.995911 4.865186 4.306878 1.236770 6.053912 6.416925 4.985713
 [8] 3.357604 5.620513 6.730208
\end{verbatim}
...
\begin{verbatim}
 [1] 6.099410 2.609672 4.109623 5.996368 1.756864 5.925215 5.580484
 [8] 4.496061 6.247924 3.458987
\end{verbatim}
...
\section{Regression Assumptions}\label{regression-assumptions-1}

\subsection{Seminar}\label{seminar-9}

In this seminar, you will be required to work more on your own. Start by
clearing your workspace and setting your working directory.
...
\begin{quote}
Answer: The Hausman test shows that we reject the null hypothesis - both
random effects model and fixed effects model are consistent. The unique
errors ui are correlated with the regressors. Therefore, we must rely on
