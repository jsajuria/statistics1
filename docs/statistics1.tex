...
\begin{verbatim}
 [1] 6.506130 4.663583 1.669951 5.577962 5.250446 1.596955 5.222414
 [8] 1.569553 6.008602 4.262257
\end{verbatim}
...
\begin{verbatim}
 [1] 1.263024 4.498971 2.361404 1.829062 4.896476 2.843880 6.880668
 [8] 4.600142 5.497118 5.960136
\end{verbatim}
...
In the first part of this seminar, we cover R\^{}2, adjusted R\^{}2. In
the second, we cover interactions. First, an interaction between
...
approximates this is called \textbf{\emph{undp\_hdi}} (the United
Nations human development index). The variable is continuous and has a
theoretical range from 0 to 1. Larger values correspond to better life
quality.

If we did not have any information on a country, our best prediction for
every country would be the mean of \textbf{\emph{undp\_hdi}}. We would
make some mistakes. But on average, this would be our best prediction.
...
values of \textbf{\emph{undp\_hdi}} in every country and the mean of
\textbf{\emph{undp\_hdi}}.
...
our variable \textbf{\emph{undp\_hdi}}. At this point you should see
that what we did so far, is the first step to getting variance. Dividing
the sum of the squared deviations by \(n-1\) would give us the variance
of \textbf{\emph{undp\_hdi}}. The variance quantifies the variability of
a variable.
...
The overall variance of \textbf{\emph{undp\_hdi}} is 0.0343445.

Let's say, we have additional information about a country like for
example its wealth. Wealth is measured by the variable
\textbf{\emph{wdi\_gdpc}}. We now run a linear model where we predict
\textbf{\emph{undp\_hdi}} using the information in
\textbf{\emph{wdi\_gdpc}}. If the regression coefficient of
\textbf{\emph{wdi\_gdpc}} is significant, that means that both variables
are related. This in turn means that we can explain some of the
variability in \textbf{\emph{undp\_hdi}} using variability in
\textbf{\emph{wdi\_gdpc}}.
...
The coefficient of \textbf{\emph{wdi\_gdpc}} is indeed significant.
Let's plot the relationship in a scatterplot and draw the regression
line.
...
For now, you should see that using the variability in
\textbf{\emph{wdi\_gdpc}} we actually explain some of the variability in
\textbf{\emph{undp\_hdi}}. We do not explain all of the variability.
There are still differences between our predictions (the points on the
line) and actual outcomes. Were we to explain all of the variability,
all of the points would be on the line. They are not. They never will be
in real-life applications. The social world is complex. However, we can
ask: ``How much of the variability in \textbf{\emph{undp\_hdi}} do we
explain using the variability in \textbf{\emph{wdi\_gdpc}}.
...
plug in the value of \textbf{\emph{wdi\_gdpc}} for every row in the
dataset.
...
between the actual outcome of \textbf{\emph{undp\_hdi}} and our model
...
The squared residuals are the variability in \textbf{\emph{undp\_hdi}}
which we have \emph{NOT} explained with the variability in
\textbf{\emph{wdi\_gdpc}}.
...
\textbf{\emph{undp\_hdi}} do we explain using variability in
\textbf{\emph{wdi\_gdpc}}.''
...
Let's take the unexplained variance of \textbf{\emph{undp\_hdi}} instead
of the unexplained sum of squares.
