...
In today's seminar, we introduce packages. We will repeat getting measures of central tendency and dispersion. We then move to estimating probabilities in marginal, joint and conditional distributions.
