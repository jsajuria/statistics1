...
world_data <- read.dta("http://uclspp.github.io/PUBLG100/data/qog_std_cs_jan15.dta")
...
We wrote a midterm sample for you to get a feeling for the format. For section 3, you need to also download the dataset below. 

<div class="container btn-container">
  <a href="http://philippbroniecki.github.io/philippbroniecki.github.io/assets/data/sample_midterm_question.pdf" type = "button" class = "btn btn-lg btn-primary">Midterm Sample Questions</a>
  <a href="http://philippbroniecki.github.io/philippbroniecki.github.io/assets/data/econ_data.RData" type = "button" class = "btn btn-lg btn-primary">Midterm Sample Dataset</a>
  <a href="http://philippbroniecki.github.io/philippbroniecki.github.io/assets/data/midterm_revision.pdf" type = "button" class = "btn btn-lg btn-primary">Midterm Revision Slides</a>
</div>
