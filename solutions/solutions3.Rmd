...
The probability that a country is richer than 55 000 is 1 minus the cumulative proability of 55000. 
...
The approach is simmilar but we want the conditional cumulative distribution, where the condition is that a country is a former colony.
...
The probability is 0.009. The probability that a former colony is that rich is slighlty lower than that any country is.

#### Exercise 9

Compute the conditional expectation of wealth (gdp per capita) for a former colony.

The conditional expectation is the mean of wealth among all former colonies. We know how to do this from last week. We take the mean of wealth and subest using square brackets.
...
Interesting, the standard deviation is greater than the mean. Apparantly, former colonies are very different. Some do poorly and some extremely well.
...
We compute the cumulative proabilities that a country has 31 000 and 25 000 and then take the difference.
...
Subsetting with 2 conditions in square brackets may be new to you. We did that with `&` operator which means "and".
